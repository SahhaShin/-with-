...
public class Protocol {
	...
	//MakeRoomGUI
	public static final String MAKE_Y = "YES: Please enter your new room name:";
	public static final String MAKE_N = "NO: Please enter your origin room name:";
	
	//Y_MakeRoomGUI
	public static final String MAKEROOM = "makeroom: Make new room:";
	
	public static final String ENTER_Y = "entersuccess: Enter the room : ";
	
	public static final String MAKE_ROOM_QUESTION = "m_question: do you want making a room?:";
	
	public static final String JOIN_ROOM = "joinroom: do you want entering a room?:";

	

	//SignUpGUI 
				
	public static final String ADD = "add: Check if it can be added to member:";
	public static final String FILE_FAIL = "file fail: Failed to read the member file.";
